...
author: "José Carlos García Alanis, Jan Goettmann, Cordula Hunt, Florian Kobylka,
  Wanja Hemmerich, \n Mareike Hülsemann, Christoph Löffler, Lisa Renziehausen, Anna-Lena Schubert, Simon
  Schaefer, Meike Steinhilber"
date: "`r Sys.Date()`"
output:
  html_document:
    df_print: paged
...
description: "Dies ist eine Einführung in R, die in verschiedenen Lehrveranstaltungen
  der Arbeitseinheiten *Analyse und Modellierung komplexer Daten* und *Methodenlehre
  und Statistik* des Psychologischen Instituts der Johannes Gutenberg-Universität
  Mainz genutzt werden.\n"
link-citations: true
