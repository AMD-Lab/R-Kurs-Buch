...
```
Die Information für Marvel DC wird auf dem äußeren Kreis, die für DC Comics auf dem inneren Kreis abgebildet (...).
...
-   `identity` -- wahre Werte an wahrer Position,  das heißt ...
(hier kann man Plots z.B. durch den alpha Parameter entzerren)
