...
In diesem Kapitel berechnen wir verschiebe statische Maße, um einen Überblick (oder einen ersten Eindruck)
...
Datensatzes, wie die Anzahl and Beobachtungen (i.e., `obs.` für observations) und 
Variablen (i.e., `variables`). Wie Sie wissen, Beobachtungen stehen in den Zeilen und Variablen in den
...
Die Spannweite beträgt also `2.4`. Dies bedeutet, dass Unterschied zwischen des breitesten und des dünsten Kelchblattes 2.4 cm beträgt.
...
x_{m+1} \,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\, für \, ungerades \, n \,\,\,=2m+1 \\
\frac{1}{2}\left(x_{m}+x_{m+1}\right) \,\,\,\,\, für \, gerades \,n \,\,\,= 2m
\end{array}\right.
$$
...
Sortiert man die Beobachtungswerte der Größe nach, so entspricht der Median bei einer ungeraden Anzahl von Beobachtungen den Wert der in der Mitte dieser Folge liegenden Beobachtung. Bei einer geraden Anzahl von Beobachtungen gibt es kein einzelnes mittleres Element, sondern zwei. Der Median entspricht dann (vereinfacht ausgedruckt), der Mittelwert dieser beiden Beobachtungen.
...
einer Variable. Der Mittlwert (i.S. des arithmetischen Mittels) ist die Summe der gegebenen 
