...
Benutzen Sie `head(data)`, um die ersten 6 Zeilen des Datensatzes zu sehen.
...
welches als der Abstand zwischen dem 75. und 25. Perzentil definiert ist.
...
# Die Argumente definieren folgende Eigenschaften für dargestellte Datenpunkte in der Grafik:
# col: Farbe
# cex: Größe
# pch: Art des Symbols
# lwd: Linienstärke des Symbols
```
