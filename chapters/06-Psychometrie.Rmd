...
$$\text{neuer Wert} = \text{maximaler Wert} \text{ - } \text{alter Wert}$$
Wenn also die höchste Antwortkategorie eines Fragebogens den Wert $3$ hat, dann rechnen wir für alle negativ gepolten Items $\text{neuer Wert} = 3 \text{ - } \text{alter Wert}$. Auch dazu kann man wieder die Funktion `mutate` nutzen:
