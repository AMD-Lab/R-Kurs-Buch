...
$$\text{neuerWert} = \text{maximalWert} \text{ - } \text{alterWert}$$
Wenn also die höchste Antwortkategorie eines Fragebogens den Wert $3$ hat, dann rechnen wir für alle negativ gepolten Items $\text{neuerWert} = 3 \text{ - } \text{alterWert}$. Auch dazu kann man wieder die Funktion `mutate` nutzen:
