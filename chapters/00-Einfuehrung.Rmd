...
In der Regel werden Sie für jedes Projekt ein eigenes Working Directory anlegen, in dem Sie die Daten und Skripte speichern, die zu dem Projekt gehören. Um in das richtige Verzeichnis zu wechseln, können Sie den Befehl `setwd()` nutzen. Dabei ist zu beachten, dass alle im Dateipfad enthaltenen "\" zu "/" oder "\\" umgeändert werden müssen. Noch einfacher geht es per Mausklick über Session &#8594;  Set Working Directory &#8594;  Choose Directory.
