...
```
Versuchen Sie aus verschiedenen Datentypen einen Vektor zu bilden, werden sie zu dem komplexeren Typen von beiden umgewandelt. Die Datentypen-Übersichtstabelle ist von komplex zu einfach (1--4) geordnet. Die Umwandlung des Datentypen nennt sich `coercion`:
